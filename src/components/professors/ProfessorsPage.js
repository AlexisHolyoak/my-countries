...
class ProfessorsPage extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log(this.props.professors.length);
    var filtrado = professors.filter(n=>regex.test(n.title));
        ...
        {this.props.loading ? (
          <Spinner />
            ...
            {/* <form className="form-inline"> */}
              ...
              <button className="btn btn-outline-success my-2 my-sm-0 mr-md-3" type="submit" onClick={this.handleTodosProfessors}>Todos los Profesores</button>
            {/* </form>             */}
              <ProfessorList
